...
# # Prepare input registrations to add to coded registrations
# # NOTE: Manually added registrations from pre-numbat repository
# all_input_registrations <- readr::read_csv(here::here("data", "manual", "cleaned-registrations-3.csv"))
#
# input_registrations <-
#
#   all_input_registrations |>
#
#   # ALTERNATIVELY: limit to registrations for trials included in numbat
...
#   full_join(input_registrations, by = c("id", "trn", "registry")) |>
#
#   arrange(id)
#
# # NOTE: `registrations_source` includes many duplicates from different usernames as uploaded to numbat
# janitor::get_dupes(registrations_source, id, trn, registry)
#
# readr::write_csv(registrations_source, here::here(dir_cleaned, paste0(latest_export_date, "_registrations-with-source.csv")))
#
# registrations <-
#   registrations_source |>
